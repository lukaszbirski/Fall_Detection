...
import pl.example.android.architecture.blueprints.todoapp.databinding.ActivityLockScreenBinding
import pl.example.android.architecture.blueprints.todoapp.extensions.visibleOrGone
import pl.example.android.architecture.blueprints.todoapp.presentation.viewmodel.LockScreenViewModel
...
class LockScreenActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.apply {
            stopService(this@LockScreenActivity)
